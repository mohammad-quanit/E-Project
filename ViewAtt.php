...
<br><br><br>
	...
	<div class="container" style="background-color: lightgrey; border-radius: 10px;"><br>
  			<h1 align="center">Students Attendance Viewer.</h1>
  			<a href="attendance.php" class="btn btn-info pull-right">Take Attendance?</a>
  		...
  		<div class="panel panel-body">
  				<table class="table table-striped">
				      ...
				      <tr>
				      	<th>Serial Num</th>
				        <th>Att. Date:</th>
				        <th class="pull-right">Show Attendance:</th>
				      </tr>
				    <!-- </thead> -->
					
				<?php 

						$result = mysqli_query($conn, "SELECT distinct ATT_Date FROM attendance_record");
						$serialNum = 0;
				...
				?>
						<tr>
							...
							<td><?php date_default_timezone_set('Asia/Karachi'); $date=$row['ATT_Date'];  echo $date;  ?></td>
						  		
						  	<td>
						  		<form action="showAttendance.php" method="post" enctype="multipart/form-data">
						  			<input type="hidden" name="date" value="<?php echo $date ?>">
						  			<input type="submit" value="Show Attendance" class="btn btn-primary pull-right">
						  		</form>
						  	</td>
						</tr>
...
<!-- <td><?php echo $row['ATT_FName']; ?></td>
						  		<input type="hidden" value="<?php echo $row['ATT_FName']; ?>">

						  	<td><?php echo $row['ATT_LName']; ?></td>
						  		<input type="hidden" value="<?php echo $row['ATT_LName']; ?>">

						  	<td><?php echo $row['ATT_Batch']; ?></td>
						  		<input type="hidden" value="<?php echo $row['ATT_Batch']; ?>">

						  	<td><?php echo $row['ATT_Status']; ?></td>
						  		<input type="hidden" value="<?php echo $row['ATT_Status']; ?>">