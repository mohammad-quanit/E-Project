<?php 
	...
	if (isset($_POST['submit'])) 
	{
		...
		$date = date("Y-m-d");
				...
				{
					$std_fname = $_POST['std_fname'][$id];
					$std_lname =  $_POST['std_lname'][$id];
					$std_batch =  $_POST['std_batch'][$id];
					


					$qu = mysqli_query($conn, "INSERT INTO 
								attendance_record (ATT_Date, ATT_FName, ATT_LName, ATT_Batch, ATT_Status)
								VALUES ('$date', '$std_fname', '$std_lname', '$std_batch', '$attendance_status')");
...
<div class="container" style="background-color: lightgrey; border-radius: 10px;"><br>
  			<h1 align="center">Students Attendance Table.</h1>
  			<a href="ViewAtt.php" class="btn btn-info pull-right">View By Date</a>
...
<!-- <?php  echo $date  = date("D M j G:i:s T Y   e");; ?> -->
